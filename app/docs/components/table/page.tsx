  ...
  return (
    <div className="min-h-screen bg-background py-8 md:py-12 pr-8 md:pr-12">
      <div className="mx-auto max-w-3xl pl-8 md:pl-12">
        <h1 className="mb-4 text-5xl font-bold">Table</h1>
        ...
        <div className="prose prose-lg max-w-none space-y-6">
          <p>
            The Table component provides semantic HTML table elements with consistent styling.
            It includes support for headers, bodies, footers, and captions. Built from scratch
            using React and native HTML table elements. No dependencies on any UI library.
          </p>
      ...
      <TableFooter>
        <TableRow>
          ...
          <div className="rounded-lg border-2 border-foreground p-6 neobrutalism-shadow space-y-6">
            <div>
              <h3 className="text-xl font-bold mb-4">Default Table</h3>
              <Table>
                <TableCaption>A list of your recent invoices.</TableCaption>
                <TableHeader>
                  <TableRow>
